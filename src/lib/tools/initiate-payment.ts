...
export const initiatePayment = tool({
  description:
    "Initiate Stripe Checkout for the appropriate tier — Legal Strategy Session (non-urgent) or Initial Deposit for Urgent Court Matter (urgent). This renders a payment form on the client side. Use this after the visitor has confirmed their urgency selection and reviewed the cost disclosure.",
